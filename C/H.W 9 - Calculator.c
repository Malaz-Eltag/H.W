...
printf(" %.2f %c %.2f = %.2f",First_Number[10],choice,Second_Number[10],Add1);}


else if ( choice == '-') { 
printf("Your equation is : \n"); 
printf(" %.2f %c %.2f = %.2f",First_Number[10],choice,Second_Number[10],sub1); }


else if ( choice == '/')   {
    printf("Your equation is : \n");
    printf(" %.2f %c %.2f = %.2f",First_Number[10],choice,Second_Number[10],Div1); }


else if (choice == '*') {
    printf("Your equation is : \n");
    printf(" %.2f %c %.2f = %.2f",First_Number[10],choice,Second_Number[10],Mult1); }
